@info "Plotings begin"
task_data = []
T = start_time+Batching_Interval+1:end_time
# println(T)
for i in I
       for t in T
              for j in J
...
for (idx, (task_name, task_start_time, task_end_time,task,unit)) in enumerate(task_data)
       ...
       plot!(gantt_task, rect_x, rect_y, seriestype=:shape, lw=1, label="", color=task_colors[task])
       plot!(gantt_unit, rect_x, rect_z, seriestype=:shape, lw=1, label="", color=task_colors[unit])
...
savefig(gantt_task,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-grantt_chart-unit-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
savefig(gantt_unit,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-grantt_chart-task-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
...
savefig(Inventory_plot,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-Inventory_profile-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
...
savefig(Purchase_plot,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-Raw_Material_Purchased-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
...
savefig(Sale_plot,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-Sales-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
...
savefig(product_inventory_level_plot ,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-Product_inventory_profile-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
...
savefig(utility_plot,"Scenario-$scenario/Batching_Interval-$Batching_Interval-Fixed_Horizon-$Fixed_Horizons/All-Utility_profile-$iter-BS-$Batching_Interval-FH-$Fixed_Horizon-PH-$Planning_horizon.png")
